...
?>
<!-- wp:cover {"customOverlayColor":"#eb4c77","isUserOverlayColor":true,"contentPosition":"center center","isDark":false,"metadata":{"categories":["banner","call-to-action"],"patternName":"core/heading-paragraph-button-with-two-images","name":"Heading, Paragraph, Button with Two Images"},"align":"full","style":{"spacing":{"padding":{"top":"6vw","right":"6vw","bottom":"6vw","left":"6vw"},"margin":{"top":"0"}}}} -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-base-color has-contrast-background-color has-text-color has-background has-custom-font-size wp-element-button" style="border-radius:0px;padding-top:24px;padding-right:48px;padding-bottom:24px;padding-left:48px;font-size:16px;font-style:normal;font-weight:500;letter-spacing:0px;text-transform:uppercase">Sign up</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
