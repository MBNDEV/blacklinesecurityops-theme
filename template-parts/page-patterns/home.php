...
return array(
	...
	'custom_fields'       => array(),
	'content'             => <<<'EOD'
<!-- wp:mbn-theme/div-wrap {"backgroundImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/bg-sechero.jpg","backgroundImageId":69,"backgroundType":"image","customClassName":"hero_test","borderWidth":"0","metadata":{"name":"Home Hero","patternName":"core/block/906"},"className":"sec_hero","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0px","right":"0px"}}}} -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#get-in-touch">REQUEST PROTECTION BRIEFING</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div></div>
<!-- /wp:mbn-theme/div-wrap -->

<!-- wp:mbn-theme/div-wrap {"divId":"our-standards","metadata":{"patternName":"core/block/909","name":"Section - Ops Standard"},"className":"sec_nextfold","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"padding":{"top":"80px","bottom":"80px"}}},"backgroundColor":"black","textColor":"white"} -->
<div id="our-standards" class="wp-block-mbn-theme-div-wrap div-wrap-block sec_nextfold has-white-color has-black-background-color has-text-color has-background has-link-color" style="padding-top:80px;padding-bottom:80px"><div class="div-wrap-content"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"58%"} -->
<div class="wp-block-column" style="flex-basis:58%"><!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-brand.svg","iconImageId":368,"iconPosition":"left","iconSize":72,"titleTag":"h2","titleClass":"text_gradient","className":"heading_icon"} -->
...
<!-- wp:mbn-theme/slider-item -->
<div class="wp-block-mbn-theme-slider-item slider-item"><div class="slider-item-content"><!-- wp:mbn-theme/image-box {"imageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/img-02.jpg","imageId":203,"imagePosition":"background","title":"Security management and risk consulting","titleTag":"h3","content":"\u003cp\u003e\u003c/p\u003e","showList":false} -->
...
<!-- wp:mbn-theme/slider-item -->
<div class="wp-block-mbn-theme-slider-item slider-item"><div class="slider-item-content"><!-- wp:mbn-theme/image-box {"imageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/img-05.jpg","imageId":200,"imagePosition":"background","title":"Compliance","titleTag":"h3","content":"\u003cp\u003ewith all federal, state, and local regulatory requirements\u003c/p\u003e","showList":false} -->
...
<!-- wp:mbn-theme/slider-item -->
<div class="wp-block-mbn-theme-slider-item slider-item"><div class="slider-item-content"><!-- wp:mbn-theme/image-box {"imageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/img-03.jpg","imageId":202,"imagePosition":"background","title":"Comprehensive protection","titleTag":"h3","content":"\u003cp\u003eanytime, anywhere\u003c/p\u003e","showList":false} -->
...
<!-- wp:mbn-theme/slider-item -->
<div class="wp-block-mbn-theme-slider-item slider-item"><div class="slider-item-content"><!-- wp:mbn-theme/image-box {"imageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/img-07.jpg","imageId":198,"imagePosition":"background","title":"Scalable Solutions","titleTag":"h3","content":"\u003cp\u003escalable protective solutions based on evolving risk levels\u003c/p\u003e","showList":false} -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/about#who-we-support">LEARN WHO WE SUPPORT</a></div>
<!-- /wp:button --></div>
...
<!-- wp:mbn-theme/div-wrap {"divId":"leadership","className":"sec_leadership","style":{"elements":{"link":{"color":{"text":"#b6b8bd"}}},"color":{"text":"#b6b8bd"},"spacing":{"padding":{"top":"50px","bottom":"50px"}}},"backgroundColor":"black"} -->
<div id="leadership" class="wp-block-mbn-theme-div-wrap div-wrap-block sec_leadership has-black-background-color has-text-color has-background has-link-color" style="color:#b6b8bd;padding-top:50px;padding-bottom:50px"><div class="div-wrap-content"><!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-brand.svg","iconImageId":368,"iconPosition":"left","iconSize":72,"titleTag":"h2","titleClass":"text_gradient has_hr","className":"leadership_title"} -->
...
<figure class="wp-block-image size-full"><img src="http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/img-brad-battaglia2.webp" alt="" class="wp-image-451"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column is-vertically-aligned-bottom copy" style="flex-basis:62%"><!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-brand.svg","iconImageId":368,"iconPosition":"left","titleTag":"h2","titleClass":"text_gradient","metadata":{"name":"Title with icon"},"className":"heading_icon"} -->
...
<!-- wp:mbn-theme/div-wrap {"divId":"get-in-touch","className":"sec_getintouch","style":{"elements":{"link":{"color":{"text":"#b6b8bd"}}},"color":{"text":"#b6b8bd"}},"backgroundColor":"black"} -->
<div id="get-in-touch" class="wp-block-mbn-theme-div-wrap div-wrap-block sec_getintouch has-black-background-color has-text-color has-background has-link-color" style="color:#b6b8bd"><div class="div-wrap-content"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-brand.svg","iconImageId":368,"iconPosition":"left","titleTag":"h2","titleClass":"text_gradient","metadata":{"name":"Title with icon"},"className":"gitcopy heading_icon"} -->
...
<div class="wp-block-group get_info"><!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-email.svg","iconImageId":464,"iconPosition":"left","iconSize":32,"titleTag":"h4","titleColor":"#ffffff","className":"flex_column"} -->
<div class="wp-block-mbn-theme-icon-box icon-box icon-position-left flex_column"><div class="icon-box-inner flex gap-4 flex-row items-start text-left"><div class="icon-box-icon" style="flex-shrink:0"><img src="http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-email.svg" alt="" style="width:32px;height:32px;object-fit:contain"/></div><div class="icon-box-content" style="flex:1px"><h4 class="icon-box-title" style="color:#ffffff"><strong>Email</strong></h4><div class="icon-box-description"><p><a href="mailto:info@blacklinesecurityoperations.com">info@blacklinesecurityoperations.com</a></p></div></div></div></div>
<!-- /wp:mbn-theme/icon-box -->

<!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-phone.svg","iconImageId":463,"iconPosition":"left","iconSize":32,"titleTag":"h4","titleColor":"#ffffff","className":"flex_column"} -->
<div class="wp-block-mbn-theme-icon-box icon-box icon-position-left flex_column"><div class="icon-box-inner flex gap-4 flex-row items-start text-left"><div class="icon-box-icon" style="flex-shrink:0"><img src="http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-phone.svg" alt="" style="width:32px;height:32px;object-fit:contain"/></div><div class="icon-box-content" style="flex:1px"><h4 class="icon-box-title" style="color:#ffffff"><strong>Phone</strong></h4><div class="icon-box-description"><p><a href="tel:+1 (844) 225-3546">+1 (844) 225-3546</a></p></div></div></div></div>
<!-- /wp:mbn-theme/icon-box -->

<!-- wp:mbn-theme/icon-box {"iconImageUrl":"http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-mapin.svg","iconImageId":462,"iconPosition":"left","iconSize":32,"titleTag":"h4","titleColor":"#ffffff","className":"flex_column"} -->
<div class="wp-block-mbn-theme-icon-box icon-box icon-position-left flex_column"><div class="icon-box-inner flex gap-4 flex-row items-start text-left"><div class="icon-box-icon" style="flex-shrink:0"><img src="http://blacklinesecurityops.dev.local/wp-content/uploads/2026/04/icon-mapin.svg" alt="" style="width:32px;height:32px;object-fit:contain"/></div><div class="icon-box-content" style="flex:1px"><h4 class="icon-box-title" style="color:#ffffff"><strong>Office</strong></h4><div class="icon-box-description"><p>Blackline Guardian Fund, United States</p><p><a href="#" class="btn_getdir">Get directions</a></p></div></div></div></div>
<!-- /wp:mbn-theme/icon-box --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
